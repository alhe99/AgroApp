...
session_start();
	...
	$consulta = "select id,nombre,precio,descripcion,imagen from productos where nombre LIKE '%".$filtro."%'  order by id desc";
...
<div class="row" >
			...
			<div class="card  mb-3 border-dark ">
				...
				<a  href="./images/resource_img/<?php echo $fila['imagen']; ?>" target="_blank" ><img class="img-responsive card-img-top " src="./images/resource_img/<?php echo $fila['imagen']; ?>" style="width: 50%;display: block;margin-left: auto;margin-right: auto; margin-top: 4px;"></a>
	...
	?>
		<div class="alert alert-dark" role="alert">
		  No hay producto que concidan con su parametro de búsqueda!
		</div>
